...
SUB_PATH = os.environ.get('SUB_PATH', 'ppwq')           # 订阅token,默认sub，例如：https://www.google.com/sub
UUID = os.environ.get('UUID', 'a69b20fc-a6c1-4121-9882-daa8c2a031b6')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'koyeb.wyp.us.ci')        # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiMTcxNjEzYjZkNTdjZTY2YzdhMWQ2OGQzMGEyMDBlYTYiLCJ0IjoiYjJkOGQ2OWMtNzY2Yi00MWFmLWJlMDAtZDA1N2E1NzQwZTg0IiwicyI6Ik1UTm1PR1l4TW1JdFl6a3pNQzAwWXpVNUxUazFaVFF0TkdWak9HTmtZMk16T1RZdyJ9')            # Argo固定隧道密钥,留空即使用临时隧道
